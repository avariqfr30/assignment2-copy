...
<head>
    ...
    <!-- PayPal SDK -->
    <script src="https://www.paypal.com/sdk/js?client-id=<?php echo PAYPAL_ID; ?>&currency=<?php echo PAYPAL_CURRENCY; ?>"></script>
</head>
<body onload="onGooglePayLoaded()">
    ...
    <div class="container">
        ...
        <div class="payment-options">
            <button class="btn btn-light" onclick="selectPaymentMethod('paypal')">alt="PayPal" style="width: 100px;">
            </button>
